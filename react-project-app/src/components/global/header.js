                            ...
                            <div className="col-lg-8 col-sm-6 col-md-8">
                                ...
                                <div className="search-box">
                                    <form action="cat" method="POST" id="search_mini_form" name="Categories">
                                        ...
                                        <input type="text" placeholder="Search here..." value=""  className="" name="search" id="search" />
                                                    ...
                                                    <li className="item even">
                                                        ...
                                                        <div className="detail-item">
                                                            <div className="product-details">
                                                                <a href="" title="Remove This Item"  className="glyphicon glyphicon-remove">&nbsp;</a>
                        ...
                        <div className="nav-inner">
                                ...
                                <ul className="navmenu">
                                    <li>
                                        ...
                                        <ul className="submenu">
                                            <li>
                                                <ul className="topnav">
                                                    <li className="level0 nav-6 level-top first parent">
                                                        <a className="level-top" href="">
                                                            <span>Pages</span>
                                                        </a>
                                                        <ul className="level0">
                            ...
                            <ul id="nav" className="hidden-xs">
                                <li id="nav-home" className="level0 parent drop-menu">
                                       <Link to="/" className="active"  refresh="true">Home</Link>
                                </li>
                                ...
                                <li className="level0 nav-6 level-top parent">
                                    <a href="grid.html" className="level-top">
                                        <span>Product</span>
                                    </a>
                                    <div className="level0-wrapper dropdown-6col">
                                        <div className="level0-wrapper2">
                                            ...
                                            <div className="nav-block nav-block-right std grid12-4">
                                                <div className="static-img-block">
                                                    <a href="">
                                ...
                                <li className="nav-custom-link level0 level-top parent"> <a className="level-top" href=""><span>Contact </span></a>
